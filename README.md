...
### Trip List
- In Trip List the user can have their own personal list of things that they need for there next trip/adventure away. Users can add items, see there items entered under the add items section, users can search for items, edit and deleted items entered. Users have full CRUD over there items entered. 
